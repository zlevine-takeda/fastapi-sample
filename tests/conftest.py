...
# WARNING: Ensure imports from `fastapi_sample` comes after this line
from fastapi_sample import app, settings, db  # noqa
from fastapi_sample.cli import create_user, cli  # noqa
