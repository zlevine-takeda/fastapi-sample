...
[![codecov](https://codecov.io/gh/zlevine-takeda/fastapi-sample/branch/main/graph/badge.svg?token=fastapi-sample_token_here)](https://codecov.io/gh/zlevine-takeda/fastapi-sample)
[![CI](https://github.com/zlevine-takeda/fastapi-sample/actions/workflows/main.yml/badge.svg)](https://github.com/zlevine-takeda/fastapi-sample/actions/workflows/main.yml)

Awesome fastapi_sample created by zlevine-takeda

## Install

from source
```bash
git clone https://github.com/zlevine-takeda/fastapi-sample fastapi_sample
cd fastapi_sample
make install
```
